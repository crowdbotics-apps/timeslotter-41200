"""
Django settings for timeslotter_41200 project.
...
ROOT_URLCONF = 'timeslotter_41200.urls'
...
WSGI_APPLICATION = 'timeslotter_41200.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "timeslotter_41200 API",
    "DESCRIPTION": "API documentation for timeslotter_41200 App",
    "VERSION": "v1",
}
